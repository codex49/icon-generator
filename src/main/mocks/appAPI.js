export default {
  ...
  getSocialsMedia: function() {
    return [
      {
        url: require('../../public/assets/img/icons/facebook.png'),
        text: 'Facebook',
      },
      {
        url: require('../../public/assets/img/icons/twitter.png'),
        text: 'Twitter',
      },
      {
        url: require('../../public/assets/img/icons/google.png'),
        text: 'Google',
      },
      {
        url: require('../../public/assets/img/icons/pinterest.png'),
        text: 'Pinterest',
      },
    ];
  },
